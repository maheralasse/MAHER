...
IePrep::IePrep () :
  ...
  m_originatorSeqNumber (0),m_processing_delay_required (0),m_bandwidth_required (0)                   //////////////
{
}
...
operator== (const IePrep & a, const IePrep & b)
{
  return ((a.m_flags == b.m_flags) && (a.m_hopcount == b.m_hopcount) && (a.m_ttl == b.m_ttl)
          ...
          && (a.m_lifetime == b.m_lifetime) && (a.m_metric == b.m_metric) && (a.m_originatorAddress
                                                                              == b.m_originatorAddress) && (a.m_originatorSeqNumber == b.m_originatorSeqNumber&& a.m_processing_delay_required == b.m_processing_delay_required && a.m_bandwidth_required == b.m_bandwidth_required));                                    //////////////
}
std::ostream &
