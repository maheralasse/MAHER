...
private:
  ...
  void ReceivePreq (IePreq preq, Mac48Address from, uint32_t interface, Mac48Address fromMp, uint32_t metric,uint8_t processing_delay_required,uint8_t bandwidth_required);             ///////////////////////
  ///\brief Handler for receiving Path Reply
  void ReceivePrep (IePrep prep, Mac48Address from, uint32_t interface, Mac48Address fromMp, uint32_t metric,uint8_t processing_delay_required,uint8_t bandwidth_required);                  ////////////
  ///\brief Handler for receiving Path Error
  void ReceivePerr (std::vector<FailedDestination>, Mac48Address from, uint32_t interface, Mac48Address fromMp,uint8_t processing_delay_required,uint8_t bandwidth_required);
